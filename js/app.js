    ...
    booksArray.docs.splice(0, 12).forEach(book => {
        ...
        div.innerHTML = `
            <div class="card h-100">
                <img src="https://covers.openlibrary.org/b/id/${book.cover_i}-M.jpg" style="height: 210px; width: auto" class="card-img-top mx-auto" alt="...">
                <div class="card-body">
                    <p>Book Name: <span class="fs-5 fw-bold">${book.title}</span></p>
                    <p>Author: <span class="fs-6">${book.author_name ? book.author_name[0] : ''}</span></p>
